(function(){
    var Main = {
        ...
        showModel: function(){
            ...
            var effectModel = '<li class="e_item"><div class="imgWrapper"><img src="Photo_files/{pic}.png" alt="" />{effect}</div></li>';
            var html = '<li class="e_item"><div class="imgWrapper"><img src="Photo_files/e0.png" alt="" />原图</div></li>';
